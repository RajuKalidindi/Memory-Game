...
function bestscore() {
  ...
  if(moves < best) {
    ...
    localStorage.setItem("score4x5", score);
  }
}
...
document.getElementById("result").innerHTML = localStorage.getItem("score4x5");
if(!isNaN(parseInt(localStorage.getItem("score4x5"), 10))){
  best = parseInt(localStorage.getItem("score4x5"), 10);
}

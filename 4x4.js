...
function bestscore() {
  ...
  if(moves < best) {
    ...
    localStorage.setItem("score4x4", score);
  }
}
...
document.getElementById("result").innerHTML = localStorage.getItem("score4x4");
if(!isNaN(parseInt(localStorage.getItem("score4x4"), 10))){
  best = parseInt(localStorage.getItem("score4x4"), 10);
}
